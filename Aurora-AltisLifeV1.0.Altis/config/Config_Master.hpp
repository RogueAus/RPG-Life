...
/* Database Related Settings */
    ...
    saved_virtualItems[] = { "pickaxe","axe","fuelEmpty","fuelFull", "spikeStrip", "lockpick", "defuseKit","storageSmall","storageBig","redgull","coffee","waterBottle","tbacon","donuts","rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtle_soup","hen","rooster","sheep","goat","defibrillator","toolkit","copRemote", "zipties", "blindfold" }; //Array of virtual items that can be saved on your player.
    ...
    save_civilian_position_restart = false; //Save civilian location on restarts?
    ...
    save_vehicle_items[] = { "pickaxe","axe","fuelEmpty","fuelFull", "spikeStrip", "lockpick", "defuseKit","storageSmall","storageBig","redgull","coffee","waterBottle","tbacon","donuts","rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtle_soup","hen","rooster","sheep","goat","defibrillator","toolkit" };
...
/* System Settings */
    ...
    clothing_masks[] = { "H_Shemag_olive", "H_Shemag_khk", "H_Shemag_tan", "H_Shemag_olive_hs", "H_ShemagOpen_khk", "H_ShemagOpen_tan", "G_Balaclava_blk", "G_Balaclava_combat", "G_Balaclava_lowprofile", "U_B_GhillieSuit", "U_O_GhillieSuit", "U_I_FullGhillie_lsh", "U_I_GhillieSuit", "U_I_FullGhillie_sard", "U_I_FullGhillie_ard", "G_Balaclava_oli", "G_Bandanna_aviator", "G_Bandanna_beast", "G_Bandanna_blk", "G_Bandanna_khk", "G_Bandanna_oli", "G_Bandanna_shades", "G_Bandanna_sport", "G_Bandanna_tan", "U_O_GhillieSuit", "U_I_GhillieSuit", "U_B_GhillieSuit", "H_RacingHelmet_1_black_F", "H_RacingHelmet_1_red_F", "H_RacingHelmet_1_white_F", "H_RacingHelmet_1_blue_F", "H_RacingHelmet_1_yellow_F", "H_RacingHelmet_1_green_F", "H_RacingHelmet_1_F", "H_RacingHelmet_2_F", "H_RacingHelmet_3_F", "H_RacingHelmet_4_F" };
    ...
    escapeMenu_displayText = "Aurora Altis Life"; //Text displayed in the escape menu. Make it short.. around 20 characters.
    ...
    paycheck_med = 2450; //Payment for medics

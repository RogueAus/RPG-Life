...
/*
    File: fn_remoteHack.sqf
    Author: Rogue
    **NOTE** Originally Tonics fn_boltcutter.sqf
    Description:
    Breaks the lock on a single gate (Closest door to the player).
    //TODO Change this to work only with Police and fed reserve gates
*/
...
if (life_HC_isActive) then {//ToDo Add a crime for B&E into a Gov Facility
